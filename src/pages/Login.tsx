  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Login Form */}
        <div className="bg-card border border-border rounded-xl p-8 shadow-2xl glow-primary">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-primary text-primary-foreground border border-border font-medium py-3 px-4 rounded-lg transition-all duration-300 glow-primary disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
